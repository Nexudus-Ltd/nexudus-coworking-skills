...
| `nexudus resellerpayouts list --new-reseller-invoice-data-url <value> --clear-reseller-invoice-data <value> --agent` | Filter resellerpayouts by properties |
...
`--new-reseller-invoice-data-url`, `--clear-reseller-invoice-data`

#### ResellerPayout create options

`--new-reseller-invoice-data-url`, `--clear-reseller-invoice-data`, `--payout-invoices` (list, repeat flag), `--added-payout-invoices` (list, repeat flag), `--removed-payout-invoices` (list, repeat flag)
