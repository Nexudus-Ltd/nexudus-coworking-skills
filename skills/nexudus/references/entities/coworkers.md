...
| `nexudus coworkers create --full-name <value> --email <value> --country-id <value> --timezone-id <value> --invoicing-business-id <value> --agent` | Create coworker |
