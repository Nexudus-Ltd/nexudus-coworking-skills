...
`--issued-by-id`, `--responsible-id`, `--coworker-id`, `--reference`, `--notes`, `--proposal-status`, `--document-to-send-id`, `--document-to-sign-id`, `--document-to-sign-html`, `--new-document-to-sign-binary-document-url`, `--clear-document-to-sign-binary-document`, `--document-to-send-html`, `--new-document-to-send-binary-document-url`, `--clear-document-to-send-binary-document`, `--new-proposal-file-url`, `--clear-proposal-file`, `--tariff-id`, `--price`, `--start-date`, `--cancellation-limit-days`, `--contract-term`, `--cancellation-date`, `--expiration-date`, `--billing-day`, `--quantity`, `--discount-code-id`, `--start-date-local`, `--sent-on-local`, `--do-not-issue-invoice`

#### Proposal create options

`--issued-by-id` (required), `--responsible-id` (required), `--coworker-id` (required), `--reference` (required), `--notes`, `--proposal-status`, `--document-to-send-id`, `--document-to-sign-id`, `--document-to-sign-html`, `--new-document-to-sign-binary-document-url`, `--clear-document-to-sign-binary-document`, `--document-to-send-html`, `--new-document-to-send-binary-document-url`, `--clear-document-to-send-binary-document`, `--new-proposal-file-url`, `--clear-proposal-file`, `--tariff-id` (required), `--desks` (list, repeat flag), `--added-desks` (list, repeat flag), `--removed-desks` (list, repeat flag), `--variants` (list, repeat flag), `--added-variants` (list, repeat flag), `--removed-variants` (list, repeat flag), `--price`, `--start-date`, `--cancellation-limit-days`, `--contract-term`, `--cancellation-date`, `--expiration-date`, `--billing-day` (required), `--quantity` (required), `--discount-code-id`, `--products` (list, repeat flag), `--added-products` (list, repeat flag), `--removed-products` (list, repeat flag), `--contracts` (list, repeat flag), `--added-contracts` (list, repeat flag), `--removed-contracts` (list, repeat flag), `--schedules` (list, repeat flag), `--added-schedules` (list, repeat flag), `--removed-schedules` (list, repeat flag), `--start-date-local`, `--sent-on-local`, `--do-not-issue-invoice`

#### Proposal update options

`--issued-by-id`, `--responsible-id`, `--coworker-id`, `--reference`, `--notes`, `--proposal-status`, `--document-to-send-id`, `--document-to-sign-id`, `--document-to-sign-html`, `--new-document-to-sign-binary-document-url`, `--clear-document-to-sign-binary-document`, `--document-to-send-html`, `--new-document-to-send-binary-document-url`, `--clear-document-to-send-binary-document`, `--new-proposal-file-url`, `--clear-proposal-file`, `--added-desks` (list, repeat flag), `--removed-desks` (list, repeat flag), `--added-variants` (list, repeat flag), `--removed-variants` (list, repeat flag), `--cancellation-limit-days`, `--contract-term`, `--expiration-date`, `--products` (list, repeat flag), `--added-products` (list, repeat flag), `--removed-products` (list, repeat flag), `--contracts` (list, repeat flag), `--added-contracts` (list, repeat flag), `--removed-contracts` (list, repeat flag), `--schedules` (list, repeat flag), `--added-schedules` (list, repeat flag), `--removed-schedules` (list, repeat flag), `--start-date-local`, `--sent-on-local`

### Proposal (key fields)

`Id`, `ResponsibleFullName`, `CoworkerFullName`, `Reference`, `ProposalStatus`

**List properties (only returned by `get`, not by `list`):** `Desks`, `AddedDesks`, `RemovedDesks`, `Variants`, `AddedVariants`, `RemovedVariants`, `Products`, `AddedProducts`, `RemovedProducts`, `Contracts`, `AddedContracts`, `RemovedContracts`, `Schedules`, `AddedSchedules`, `RemovedSchedules`
