...
`--business-id`, `--name`, `--description`, `--invoice-display`, `--visible`, `--display-order`, `--from-display-order` (range), `--to-display-order` (range), `--price`, `--from-price` (range), `--to-price` (range), `--credit-price`, `--from-credit-price` (range), `--to-credit-price` (range), `--charge-period`, `--maximum-price`, `--from-maximum-price` (range), `--to-maximum-price` (range), `--default-price`, `--per-night-pricing`, `--currency-id`, `--tax-rate-id`, `--reduced-tax-rate-id`, `--exempt-tax-rate-id`, `--financial-account-id`, `--from-time`, `--from-from-time` (range), `--to-from-time` (range), `--to-time`, `--from-to-time` (range), `--to-to-time` (range), `--min-length`, `--from-min-length` (range), `--to-min-length` (range), `--max-length`, `--from-max-length` (range), `--to-max-length` (range), `--only-within-available-times`, `--fixed-cost-length`, `--from-fixed-cost-length` (range), `--to-fixed-cost-length` (range), `--fixed-cost-price`, `--from-fixed-cost-price` (range), `--to-fixed-cost-price` (range), `--only-for-contacts`, `--only-for-members`, `--booking-credit`, `--printing-credit`, `--apply-to-visitors`, `--price-factor-low-demand`, `--from-price-factor-low-demand` (range), `--to-price-factor-low-demand` (range), `--price-factor-average-demand`, `--from-price-factor-average-demand` (range), `--to-price-factor-average-demand` (range), `--price-factor-high-demand`, `--from-price-factor-high-demand` (range), `--to-price-factor-high-demand` (range), `--price-factor-last-minute`, `--from-price-factor-last-minute` (range), `--to-price-factor-last-minute` (range), `--last-minute-period`, `--from-last-minute-period` (range), `--to-last-minute-period` (range), `--last-minute-adjustment-type`, `--apply-from`, `--from-apply-from` (range), `--to-apply-from` (range), `--apply-to`, `--from-apply-to` (range), `--to-apply-to` (range), `--resource-type-names`, `--from-created-on` (range), `--to-created-on` (range), `--from-updated-on` (range), `--to-updated-on` (range)

#### ExtraService create options

`--business-id` (required), `--name` (required), `--description`, `--invoice-display`, `--visible`, `--display-order` (required), `--resource-types` (list, repeat flag), `--added-resource-types` (list, repeat flag), `--removed-resource-types` (list, repeat flag), `--price` (required), `--credit-price`, `--charge-period` (required), `--maximum-price`, `--default-price`, `--per-night-pricing`, `--currency-id` (required), `--tax-rate-id`, `--reduced-tax-rate-id`, `--exempt-tax-rate-id`, `--financial-account-id`, `--from-time`, `--to-time`, `--min-length`, `--max-length`, `--only-within-available-times`, `--fixed-cost-length`, `--fixed-cost-price`, `--tariffs` (list, repeat flag), `--added-tariffs` (list, repeat flag), `--removed-tariffs` (list, repeat flag), `--only-for-contacts`, `--only-for-members`, `--booking-credit`, `--printing-credit`, `--apply-to-visitors`, `--price-factor-low-demand`, `--price-factor-average-demand`, `--price-factor-high-demand`, `--price-factor-last-minute`, `--last-minute-period`, `--last-minute-adjustment-type` (required), `--apply-from`, `--apply-to`, `--resource-type-names`, `--teams` (list, repeat flag), `--added-teams` (list, repeat flag), `--removed-teams` (list, repeat flag), `--time-slots` (JSON array or @filepath)
