...
| `nexudus customfields create --business-id <value> --name <value> --display-order <value> --custom-field-index <value> --agent` | Create customfield |
